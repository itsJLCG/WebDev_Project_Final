...
public function applicationPage()
{
    ...
    $applications = Application::where('user_id', $userId)->get(); // Retrieve applications for the logged-in user

    return view('application', ['applications' => $applications]); // Pass 'applications' variable to the view
} */
