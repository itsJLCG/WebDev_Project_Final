@extends('layouts.app', [
    ...
    'activePage' => 'login',
    'backgroundImage' => asset('assets') . "/img/ParishConnect_Login.jpg",
])
            ...
            <div class="card card-login card-plain">
                <div class="card-header ">
                    <div class="logo-container">
                        <img src="{{ asset('assets/img/ParishConnectLogo.png') }}" alt="" style="width: 200px; height: auto;">
                    </div>
                </div>
                <div class="card-body ">
                <div class="input-group no-border form-control-lg {{ $errors->has('email') ? ' has-danger' : '' }}">
                    ...
                    <input class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ __('Email') }}" type="email" name="email" value="{{ old('email', 'example@email.com') }}" required autofocus>
                </div>
                @if ($errors->has('email'))
