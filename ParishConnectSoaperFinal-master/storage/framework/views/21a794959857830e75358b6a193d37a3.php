        ...
        <ul class="nav">
            ...
            <li class="<?php if($activePage == 'massSchedule'): ?> active <?php endif; ?>">
                <a href="<?php echo e(route('massSchedule')); ?>">
                    <p style="font-size: 16px;"><?php echo e(__('Mass Schedule')); ?></p>
                </a>
            </li>
...
<?php /**PATH C:\xamppss\laravel\ParishConnectSoaperFinal-master\resources\views/layouts/navbars/sidebar.blade.php ENDPATH**/ ?>