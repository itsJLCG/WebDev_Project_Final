      ...
      <ul class="navbar-nav">
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
            ...
            <a class="dropdown-item" href="<?php echo e(route('generate-pdf')); ?>"><?php echo e(__("Generate Report")); ?></a>
...
<?php /**PATH C:\xamppss\laravel\ParishConnect_FinalSystem\resources\views/layouts/navbars/navs/auth.blade.php ENDPATH**/ ?>