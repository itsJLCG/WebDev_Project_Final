...
use App\Http\Controllers\EventOutsideController;
...
Route::get('/eventOutside', [EventOutsideController::class, 'index'])->name('eventOutside');
Route::get('/massScheduleOutside',[MassSchedulesController::class, 'index'])->name('massScheduleOutside');
