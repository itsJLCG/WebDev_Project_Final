...
>
    <?php if(data_get($setUp, 'detail.showCollapseIcon')): ?>
        <td
            ...
            style="<?php echo e(data_get($theme, 'table.tdBodyStyle')); ?>"
        ></td>
    <?php endif; ?>
    <?php if($checkbox): ?>
        <td></td>
    ...
    <?php $__currentLoopData = $this->visibleColumns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <td
            class="<?php echo e(data_get($theme, 'table.tdBodyClassTotalColumns') . ' ' . $column->bodyClass ?? ''); ?>"
...
<?php /**PATH C:\xamppss\laravel\WebDev_Project\vendor\power-components\livewire-powergrid\resources\views\components\table-footer.blade.php ENDPATH**/ ?>